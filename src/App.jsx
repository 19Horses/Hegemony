    ...
    <>
      ...
      <div className="description-container">
        <p className="description">
          ...
          polished floors of Soho Aouse. Its word of mout, not sponsored on
          Instagram. It's ard-to-find not igh street.
          <br />
          True radicalism in culture is always suppressed and intentionally kept
          from you. It's not plastered on billboards sponsored by Spotify.
          Culture that grows like fungus is always radical because it's a
          challenge to power from united working-class people, the ones who rise
          from the dark, and tells us not to consume the things they tell you
          to, not to live the life they tell you to, to be angry at the things
          they don't want you to. Ask yourself how we can go from form 696 to
          the playing at the Brits? That's not progress that's profit.
          <br />
          I see the London "cultural architects" with paid in partnership posts
          from Spotify and playing gigs at Soho House, making out they're the
          heartbeat of London. They might be the "heartbeat", but they're not a
          healthy heart, they're fatty & flatlining. They're only the
          "heartbeat" because there's no alternative. And that's what power
          wants.
          <br />
          ...
          clothes to make and how to wear them, or music to make or how to play
          it, that you couldn't find anywhere else in the world, to essentially
          following meaningless trends dictated or supported by power as not to
          lose or upset 'the bag,' that ultimately challenges nothing and is
          virtually the same to what you can find in places like Paris, New York
          or Amsterdam.
        </p>
      </div>
      <div className="header-container">
      ...
      <div className="description-container">
        <p className="description">
          ...
          <br />
          <br />
          <b>4. WE WANT DECENT HOUSING, FIT FOR THE SHELTER OF HUMAN BEINGS.</b>
          <br />
